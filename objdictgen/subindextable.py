...
DictionaryOrganisation = [
    ...
    {"minIndex" : 0x2000, "maxIndex" : 0x6FFF, "name" : "Manufacturer Specific"},
        ...
        if self.Editable:
            ...
            if selected != wx.NOT_FOUND:
                ...
                if self.Manager.IsCurrentEntry(index):
                    ...
                    if 0x2000 <= index <= 0x6FFF and infos["struct"] & OD_MultipleSubindexes or infos["struct"] & OD_IdenticalSubindexes:
                        showpopup = True
